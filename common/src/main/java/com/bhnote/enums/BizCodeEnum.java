...
public enum BizCodeEnum {
    ...
    CART_PRODUCT_NO_EXITS(220002, "购物车商品不存在"),
     ...
     * 订单
     */
    ORDER_CONFIRM_COUPON_FAIL(280001, "创建订单-优惠券使用失败"),
    ...
    ORDER_NOT_EXIST(280010, "订单不存在"),
    ORDER_CONFIRM_ITEM_NOT_EXIST(280011, "商品项不存在"),
     ...
     * 流控操作
     */
    CONTROL_FLOW_ERROR(500101, "限流控制异常"),
    CONTROL_DEGRADE_ERROR(500201, "降级控制异常"),
    CONTROL_AUTH_ERROR(500301, "授权控制异常"),
    CONTROL_PARAM_FLOW_ERROR(500401, "参数限流控制异常"),
    CONTROL_SYSTEM_BLOCK_ERROR(500501, "系统负载控制异常"),
